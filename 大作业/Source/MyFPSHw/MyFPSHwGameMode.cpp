	...
	: Super()
{
	...
	// static ConstructorHelpers::FClassFinder<UUserWidget> GameOverWidgetBPClass(TEXT("/Game/My/BP/UMG/GameOverUI.GameOverUI"));
	//
	// if (GameOverWidgetBPClass.Class != nullptr)
	// {
...
void AMyFPSHwGameMode::BeginPlay()
{
	...
	// 		GameOverWidget->SetVisibility(ESlateVisibility::Hidden); // 初始隐藏
	// 	}
	// }
